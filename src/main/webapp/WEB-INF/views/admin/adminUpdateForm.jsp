        ...
        <form action="/admin/updateAdmin" method="POST">
            <table id="admin_table">
                <tr>
                    ...
                    <td>
                        ${dto.admin_id}
                        <input type="hidden" id="admin_id" placeholder="아이디"
                            name="admin_id" value="${dto.admin_id}"/>
                    </td>
                </tr>
                <tr>
                    <th>PW</th>
                ...
                <tr>
                    <th>활성여부</th>
                    <td>
                        <input type='radio' name='activation' value='true' 
                        <c:if test="${dto.activation}">checked</c:if>>활성화
                        <c:if test="${dto.admin_id != 'admin'}">
	                        <input type='radio' name='activation' value='false'
	                        <c:if test="${dto.activation == false}">checked</c:if>>정지
                        </c:if>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" id="notice_area">
                        ...
                        <p>
                            활성여부는 장기휴가, 회사 징계에 따른 정직 등 
                            해당 관리자가 장기간동안 활동이 이루어지지 않을 것으로 판단될 때
                            정지 합니다.
                        </p>
                    </td>
                </tr>
