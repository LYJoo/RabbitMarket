...
<body>
    ...
    <div id="list_content">
        ...
        <table id="list_table">
            ...
            <tr>
				<td id="paging" 
                    <c:if test="${sessionScope.adminId == 'admin'}">colspan="5"</c:if>
...
<script>
    ...
    function listCall(reqPage){	//페이지 요청 함수
        var reqUrl ='./withdrawList/'+pagePerNum+"/"+reqPage; //restful 로 요청 -> /list/보여줄갯수/페이지
        $.ajax({
            url:reqUrl
            ,type:'get'
            ,data:{}
    ...
    function listPrint(list){
        ...
        for(var i=0;i<list.length;i++){
            ...
            content +="<td>"+list[i].manner_cnt+"</td>";
