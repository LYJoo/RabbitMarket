        ...
        <div id="msgContainer">
	        ...
	        <div class="msg-main_content">
	            ...
	            <div class="msg-detail-info">
	                <span class="msg-detail-info-span">받은사람 : ${dto.member_id }</span>
	                <span class="msg-detail-info-span">보낸날짜 : ${dto.send_time }</span>
	            </div>
	            <div class="msg-detail-content">
	            	${dto.msg_content }
				</div>
	            <div class="msg-detail-btn">
	                <button class="msg-btn" onclick="location.href='./replyForm?receiver=${dto.member_id }'">답장</button>
